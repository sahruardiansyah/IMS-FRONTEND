...
export default class UpdateCinema extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  onChange(e) {
    let newData = {
      ...
      tipe: this.state.postCode,
      kota: this.state.kota,
      alamat: this.state.postCode,
  ...
  componentDidMount() {
    CinemaService.getCinemaById(this.state.id).then((res) => {
  ...
  updateCinema = (e) => {
    ...
    CinemaService.updateCinema(cinema,this.state.id).then((res) => {
