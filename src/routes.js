...
const Customers =React.lazy(()=>import('./views/vendor/ListAllVendor'));
const AddCustomer = React.lazy(()=> import('./views/vendor/CreateVendor'));
const UpdateVendor = React.lazy(()=>import('./views/vendor/UpdateVendor'));
...
const routes = [
  ...
  { path: '/setting/vendors', exact: true,  name: 'Vendors', component: Customers },
  { path: '/setting/add-vendors', exact: true,  name: 'Add New Vendor', component: AddCustomer },
